 ...
 * Urutan diperbaiki: Subscriptions sebelum Users
 */
export const runAutoSeeder = async () => {
  ...
  try {
    ...
    // Jika ada satu saja yang gagal, batalkan semua agar database tidak berantakan
