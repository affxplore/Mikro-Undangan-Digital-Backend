...
Role.associate = function(models) {
  Role.belongsToMany(models.AccessLv, { 
    through: models.RoleAccessLv, //real brok??
    foreignKey: 'role_id', 
    otherKey: 'access_lv_id',
    as: 'accessLevels' 
  });
...
// ========================================
// RESPONSE FORMATTER real brokk??
// ========================================
export const roleResponse = (role) => {
  if (!role) return null;

  const raw = role.toJSON ? role.toJSON() : role;
