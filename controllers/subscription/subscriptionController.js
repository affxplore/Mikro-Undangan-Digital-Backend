...
export const createSubscriptionWithPrices = async (req, res) => {
  ...
  try {
    ...
    return successResponse(res, 201, 'Subscription berhasil dibuat', createdSubscription);
...
export const updateSubscriptionWithPrices = async (req, res) => {
  ...
  try {
    ...
    return successResponse(res, 200, 'Subscription berhasil diupdate', updatedSubscription);
    ...
    return errorResponse(res, 500, 'Gagal mengupdate subscription');
  }
};